...
const Offer = () => {
    return (
        <div className='max-w-screen-md mx-auto mt-10 md:mt-20'>
            <h2 className='text-orange-600 dark:text-white font-bold text-3xl md:text-5xl text-center py-5'>Discount on Top Selling Food</h2>
            <div className="grid gap-2 p-5 md:p-10 items-center rounded-2xl my-10 shadow-xl bg-orange-100 dark:bg-orange-600 dark:bg-opacity-50">
