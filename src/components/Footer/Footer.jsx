...
const Footer = () => {
    return (
        <div className='bg-orange-100 dark:bg-slate-900 dark:text-white p-5'>
            <div className="grid sm:grid-cols-3 p-5 gap-5 md:grid-cols-4 container mx-auto">
                <aside className='sm:col-span-3 md:col-span-1 sm:text-center md:text-left'>
                    {/* <svg
                        width="50"
                        height="50"
                        viewBox="0 0 24 24"
                    ...
                    <img src={logo} alt="Urban Foodies" className='w-24 sm:mx-auto lg:mx-0'/>
