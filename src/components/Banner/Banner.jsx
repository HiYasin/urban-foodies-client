                ...
                <div className="w-[80%] mx-auto">
                    <div className="flex flex-col gap-4 md:gap-6">
                        <div className='flex gap-2 justify-between items-center'>
                            <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold text-orange-600 md:text-balance">Let's Revolutionize Your Restaurant Experience With Us</h1>
                            <img src={logo} alt="Urban Foodies" className='w-16 sm:hidden' />
                        </div>
